...
import com.dyw.register.handler.CardGetHandler;
import com.dyw.register.handler.CardSendHandler;
...
public class CardService {
    ...
    private NativeLong buildSendCardTcpCon(NativeLong lUserID) {
        try {
            ...
            NativeLong conFlag = EgciController.hcNetSDK.NET_DVR_StartRemoteConfig(lUserID, HCNetSDK.NET_DVR_SET_CARD_CFG_V50, lpInBuffer, m_struCardInputParamSet.size(), cardSendHandler, pUserData);
            return conFlag;
        } catch (Exception e) {
            ...
            case 0:// NET_SDK_CALLBACK_TYPE_STATUS
                ...
                switch (iStatus) {
                    ...
                    case 1002:
                        ...
                        logger.error("下发卡参数失败, dwStatus: " + iStatus + " 错误号: " + EgciController.hcNetSDK.NET_DVR_GetLastError());
                        break;
                }
                break;
            default:
